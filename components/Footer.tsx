      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex items-center justify-center gap-8 mb-12">
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M13.397 20.997v-8.196h2.765l.411-3.209h-3.176V4.548c0-.926.258-1.56 1.587-1.56h1.697V.129A22.86 22.86 0 0 0 14.201 0c-2.444 0-4.122 1.492-4.122 4.231v2.361H7.332v3.209h2.747v8.202h3.318Z" />
              </svg>
              <span className="text-xs uppercase tracking-widest font-sans">Facebook</span>
            </a>
            <a 
